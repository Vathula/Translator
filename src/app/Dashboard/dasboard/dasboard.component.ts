...
export class DasboardComponent {
  ticketOptions = [
    { name: 'Zoo', icon: '../../assets/image/Zoo.jpg', class: 'zoo' },
    { name: 'Butterfly Park', icon: '../../assets/image/Butterfly.jpg', class: 'butterfly' },
    { name: 'Bus Safari Combo', icon: '../../assets/image/BusSaffari.jpeg', class: 'bus-safari' },
    { name: 'Jeep Safari Combo', icon: '../../assets/image/Jeep.jpg', class: 'jeep-safari' }
  ];
  title = 'ticketone';
  listening = false;
  ...
  private processRecognizedText(text: string): void {
    ...
    const navigateRegex = /navigate\s+(\w+)/i;
    ...
    debugger
    const navigateMatch = text.match(navigateRegex);
    if (navigateMatch && navigateMatch[1]) {
      const page = navigateMatch[1].toLowerCase();
